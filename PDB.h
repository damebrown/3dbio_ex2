...
public:
    ...
    //static const char* getAtomResidueLongName(const std::string& pdb_line);
    ...
    public:
        bool operator()(const char *PDBrec) const {
            return (!((PDBrec[17] == 'H' && PDBrec[18] == 'O' && PDBrec[19] == 'H') ||
                    ...
                    (PDB::atomAltLocIndicator(PDBrec) == ' ' ||
                     PDB::atomAltLocIndicator(PDBrec) == 'A')); // skip alternatives
        }
    };
