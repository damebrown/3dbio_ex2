...
static const std::string NUCLEIC_ACIDS = "ADEA CYTC GUAG THYT URAU  DAA  DCC  DGG  DTT  DUU UNKX";

static const unsigned short NUM_OF_NUCLEIC_RESIDUES = 27;
static const char *NUCLEIC_RESIDUES[NUM_OF_NUCLEIC_RESIDUES] = {"  A", " +A", "  C", " +C", "  G", " +G", "  I", " +I",
                                                                "  T", " +T", "  U", " +U", "1MA", "5MC", "OMC", "1MG",
                                                                "2MG", "M2G", "7MG", "OMG", " YG", "H2U", "5MU", "PSU",
                                                                "4SU", "MIA", "UNK"};
...
char PDB::residueShortName(const char *const resName) {
...
/*const char *PDB::getAtomResidueLongName(const std::string& PDBline)
{
  return PDBline.substr(atomResTypeField, 3).c_str();
  }*/
